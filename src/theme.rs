    ...
    pub const fn palette(self) -> Palette {
        match self {
            Self::Rainbow => Palette {
                ...
                zhipu: Color::Rgb(64, 120, 255),
                moonshot: Color::Rgb(190, 242, 100),
            ...
            Self::Midnight => Palette {
                ...
                zhipu: Color::Rgb(59, 130, 246),
                moonshot: Color::Rgb(45, 212, 191),
            ...
            Self::Mono => Palette {
                ...
                zhipu: Color::Rgb(238, 238, 238),
                moonshot: Color::Rgb(204, 204, 204),
...
pub const fn provider_accent(provider_id: &str, palette: Palette) -> Color {
    match provider_id.as_bytes() {
        ...
        b"zhipu" => palette.zhipu,
        b"moonshot" => palette.moonshot,
        _ => palette.border,
    }
}
